  ...
  return (
    <div className="min-h-screen bg-bg-soft">
      ...
      <main className="pt-[76px] pb-16 lg:pb-24">
        ...
        {/* Careers Section */}
        <section id="careers" className="py-10 lg:py-16">
          <div className="max-w-container mx-auto px-4 lg:px-0">
            <Reveal>
              <div className="relative bg-white border border-line rounded-3xl p-8 md:p-12 lg:p-16 shadow-soft-1 overflow-hidden">
                <div className="absolute -top-20 -right-20 w-[280px] h-[280px] bg-brand-100/60 rounded-full blur-[80px]" />
                <div className="relative z-10 grid lg:grid-cols-[1.3fr_1fr] gap-10 items-center">
                  <div>
                    <Eyebrow>Careers</Eyebrow>

                    <h2 className="mt-6 font-display text-[clamp(2rem,4.2vw,3.25rem)] font-bold text-ink leading-[1.1] tracking-[-0.025em]">
                      Join the team building <GradientText>tomorrow&rsquo;s landmark projects</GradientText>
                    </h2>

                    <p className="mt-5 text-muted leading-[1.65] max-w-[520px]">
                      If interested, send your details and CV at{' '}
                      <a
                        href="mailto:info@aumenercon.com"
                    ...
                    <div className="mt-8">
                      <a
                        href="mailto:info@aumenercon.com?subject=Career%20Inquiry%20%E2%80%94%20Aum%20Enercon"
                        className="group inline-flex items-center gap-2.5 bg-ink text-white px-6 py-3.5 rounded-full font-semibold transition-all hover:-translate-y-0.5 hover:shadow-lg"
                      >
                        Send Your CV
                      </a>
                    </div>
                  ...
                  <div className="hidden lg:flex justify-end">
                    <div className="w-[180px] h-[180px] rounded-3xl bg-gradient-to-br from-brand-50 to-brand-100 border border-brand-100 grid place-items-center shadow-soft-1">
                      <Briefcase className="w-16 h-16 text-brand-700" strokeWidth={1.4} />
                    </div>
                  </div>
                </div>
              </div>
